...
describe AcpcDealerCommunicator do
  ...
  before(:each) do
    ...
    @client_connection.gets.chomp.should eq("#{AcpcDealerCommunicator::VERSION_LABEL}:#{AcpcDealerCommunicator::VERSION_NUMBERS[:major]}.#{AcpcDealerCommunicator::VERSION_NUMBERS[:minor]}.#{AcpcDealerCommunicator::VERSION_NUMBERS[:revision]}")
